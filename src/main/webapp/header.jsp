...
<li><a href="liaotian.jsp"><i class="fas fa-comment"></i></a></li>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">


<style>
.white-bg {
background-color: #ffffff; /* 设置背景颜色为白色，可以根据需要更改颜色 */
}
</style>
<nav id="header-box">
    <div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
        ...
        <div class="navigation navigation-top clearfix white-bg">
            <ul>
                ...
                <c:choose>
                    <c:when test="${sessionScope.username != null && sessionScope.username !=  '' }">
                        <!-- 在导航栏中添加聊天功能的超链接 -->
                        <li><a href="liaotian.jsp"><i class="fas fa-bell"></i></a></li>
